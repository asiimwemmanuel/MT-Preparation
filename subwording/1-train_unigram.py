...
source_train_value = (
    ...
    + " --model_prefix=source --vocab_size=50000 --hard_vocab_limit=false --split_digits=true"
)
...
target_train_value = (
    ...
    + " --model_prefix=target --vocab_size=50000 --hard_vocab_limit=false --split_digits=true"
)
